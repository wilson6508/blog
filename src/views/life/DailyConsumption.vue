    ...
    <div class="row">
      <div class="card col-12 mb-3">
        <div class="card-body position-relative">
          ...
          <!--資料列-->
          <div class="table-responsive scrollbar" style="max-height: 260px; overflow-y: auto">
      ...
      <div class="card col-12">
        <div class="row">
          <div class="col-7"><FigTool :figure="bar"></FigTool></div>
          <div class="col-5"><FigTool :figure="pie"></FigTool></div>
        </div>
      </div>
    </div>
    <!--modal-->
